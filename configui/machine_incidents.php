              ...
              <div id="incident_selection">
                <nav class="navbar navbar-default">
                    <ul class="nav navbar-nav">
                      ...
                      echo '<li class="active" id="machine_incident_selection"><a href="machine_incidents.php?machine_id='.htmlspecialchars($_GET["machine_id"]).'">Incidents<i class="fa fa-fw fa-wrench"></i></a></li>';
                      echo '<li id="machine_files_selection"><a href="machine_files.php?machine_id='.htmlspecialchars($_GET["machine_id"]).'">Files<i class="fa fa-fw fa-book"></i></a></li>';                      
                      ?>
                    </ul>         
                </nav>
              </div>
                  ...
                  <div class="col-md-12">
                    <div class="card">
                      <div class="card-header col-md-9">
                        <h3 class="card-title text-center">Machine Incidents</h3>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                        <table id="incidents" class="table table-bordered table-striped">
                          ...
                          <?php
                            ...
                            $sql = "select * from incidents where machine_id =".htmlspecialchars($_GET["machine_id"]);
                            $result = m_execute_query($con, $sql);
