                      ...
                      <div class="card-body">
                        ...
                        <form  role="form" method="post" id="incident_form">
                            <div class="form-group">                              
                              <label>Name</label>
                                <input type='text' class='form-control' placeholder='Enter Name...' name="incident_name" id="incident_name_id">
                            </div>                            
                            <div class="form-group">
                            ...
                            <div class="form-group">                              
                              <label>Incident Location</label>
                                <input type='text' name='incidentlocation' id='incidentlocation_id' class='form-control' placeholder='Enter Location...'>
                            </div>
                            <div class="form-group">
                              ...
                              <select id="incident_user_id" class="form-control" name="incident_user">
                                ...
                                <?php
                                  ...
                                  while($row_user = mysqli_fetch_array($result_user)){
                                    echo "<option value='".$row_user["id"]."'>".$row_user["name"]." ".$row_user["surname"]."</option>";
                                  }
                                ?>
                              </select>
                            </div>
                              ...
                              <select id="incident_machine_id" class="form-control" name="incident_machine">
                                ...
                                <?php
                                  ...
                                  while($row_machine = mysqli_fetch_array($result_machine)){
                                    echo "<option value='".$row_machine["id"]."'>".$row_machine["name"]."</option>";
                                  }
                                ?>
                              </select>
                            </div>
                            ...
                            <div class="col-md-2 col-md-offset-5">
                              <button id="incident_info_submit" type="button" class="btn btn-block btn-success">Submit</button>
                            </div>
...
<script>
  ...
  $(document).on('click','#incident_info_submit',function(e) {
    if (Completed_Inputs()) {
