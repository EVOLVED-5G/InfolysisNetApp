              ...
              <div id="incident_selection">
                <nav class="navbar navbar-default">
                    <ul class="nav navbar-nav">
                      ...
                      echo '<li class="active" id="area_machines_selection"><a href="area_machines.php?area_id='.htmlspecialchars($_GET["area_id"]).'">Machines<i class="fa fa-fw fa-cogs"></i></a></li>';
                      echo '<li id="area_users_selection"><a href="area_users.php?area_id='.htmlspecialchars($_GET["area_id"]).'">Users<i class="fa fa-fw fa-users"></i></a></li>';                      
                      ?>
                    </ul>         
                </nav>
              </div>
                  ...
                  <div class="col-md-12">
                    <div class="card">
                      <div class="card-header col-md-9">
                        <h3 class="card-title text-center">Area  Machines</h3>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                        <table id="machines" class="table table-bordered table-striped">
                          ...
                          <?php
                            ...
                            $sql = "select * from machines where area =".htmlspecialchars($_GET["area_id"]);
                            $result = m_execute_query($con, $sql);
