      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="areas.php">Areas<span class="sr-only">(current)</span></a></li>
                  ...
                  <div class="col-md-12">
                    <div class="card">
                      <div class="card-header">
                        <h3 class="col-md-9 card-title text-center">Incident List</h3>
                      </div>
                      <div class="col-lg-2 col-md-3 pull-right">
                        <a href="incident_new.php"><button type="button" class="btn btn-block btn-success">Add Incident<i class="fa fa-fw fa-plus"></i></button></a>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                          ...
                          <tbody>
                            <?php
                              ...
                              while($row = mysqli_fetch_array($result)){
                                ...
                                echo "<td><a href='incident_info.php?incident_id=".$row["id"]."' title='Incident Information'><i class='fa fa-fw fa-info-circle'></i></a></td>";
                                echo "<td><a href='incident_user.php?incident_id=".$row["id"]."' title='Incident User'><i class='fa fa-fw fa-user'></i></a></td>";
                              }
                                echo "</tr>";
                            ?>
                          </tbody>
