                  ...
                  <div class="col-md-12">
                    <div class="card">
                      <div class="card-header">
                        <h3 class="col-md-9 card-title text-center">File List</h3>
                      </div>
                      <div class="col-lg-2 col-md-3 pull-right">
                        <a href="file_new.php?machine_id=0"><button type="button" class="btn btn-block btn-success">Add File<i class="fa fa-fw fa-plus"></i></button></a>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                          ...
                          <tbody>
                            <?php
                              ...
                              while($row = mysqli_fetch_array($result)){
                                ...
                                echo "<td>".$row["name"]."</td>";
                                echo "<td>".$row["link"]."</td>";
                                echo "<td><a href='machine_info.php?machine_id=".$row["machine_id"]."' title='Machine Information'><i class='fa fa-fw fa-cogs'></i></a></td>";
                              }
                                echo "</tr>";
                            ?>
                          </tbody>
