      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="areas.php">Areas<span class="sr-only">(current)</span></a></li>
                  ...
                  <div class="col-md-12">
                    <div class="card">
                      <div class="card-header">
                        <h3 class="col-md-9 card-title text-center">Area List</h3>
                      </div>
                      <div class="col-lg-2 col-md-3 pull-right">
                        <a href="area_new.php"><button type="button" class="btn btn-block btn-success">Add Area<i class="fa fa-fw fa-plus"></i></button></a>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                          ...
                          <tbody>
                            <?php
                              ...
                              while($row = mysqli_fetch_array($result)){
                                ...
                                echo "<td><a href='area_info.php?area_id=".$row["id"]."' title='Area Information'><i class='fa fa-fw fa-info-circle'></i></a></td>";
                                echo "<td><a href='area_machines.php?area_id=".$row["id"]."' title='Area Machines'><i class='fa fa-fw fa-cogs'></i></a></td>";
                                echo "<td><a href='area_users.php?area_id=".$row["id"]."' title='Area Users'><i class='fa fa-fw fa-users'></i></a></td>";
                              }
                                echo "</tr>";
                            ?>
                          </tbody>
