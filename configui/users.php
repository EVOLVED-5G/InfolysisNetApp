                  ...
                  <div class="col-md-12">
                    <div class="card">
                      <div class="card-header">
                        <h3 class="col-md-9 card-title text-center">User List</h3>
                      </div>
                      <div class="col-lg-2 col-md-3 pull-right">
                        <a href="user_new.php"><button type="button" class="btn btn-block btn-success">Create User<i class="fa fa-fw fa-plus"></i></button></a>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                          ...
                          <tbody>
                            <?php
                              ...
                              while($row = mysqli_fetch_array($result)){
                                ...
                                echo "<td>".$row["role"]."</td>";
                                echo "<td><a href='user_info.php?user_id=".$row["id"]."' title='User Information'><i class='fa fa-fw fa-info-circle'></i></a></td>";
                                echo "<td><a href='user_areas.php?user_id=".$row["id"]."' title='User Areas'><i class='fa fa-fw fa-map'></i></a></td>";
                                echo "<td><a href='user_incidents.php?user_id=".$row["id"]."' title='User Incidents'><i class='fa fa-fw fa-wrench'></i></a></td>";
                              }
                                echo "</tr>";
                            ?>
                          </tbody>
