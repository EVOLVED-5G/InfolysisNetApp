...
<div class="wrapper">
  ...
  <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="col-md-10">
          <?php 
            $sql_user = "SELECT * FROM users WHERE id = ".htmlspecialchars($_GET["user_id"]);
            $result_user = m_execute_query($con, $sql_user);
            $row_user = mysqli_fetch_array($result_user);
            echo "<h1>
              User : ".$row_user['name']." ".$row_user['surname']."
            </h1>"; 
          ?>
        </div>                
      </section>
              ...
              <div id="incident_selection">
                <nav class="navbar navbar-default">
                    <ul class="nav navbar-nav">
                      ...
                      echo '<li class="active" id="incident_questions_selection"><a href="user_areas.php?user_id='.htmlspecialchars($_GET["user_id"]).'">Areas<i class="fa fa-fw fa-map"></i></a></li>';
                      echo '<li id="incident_answers_selection"><a href="user_incidents.php?user_id='.htmlspecialchars($_GET["user_id"]).'">Incidents<i class="fa fa-fw fa-wrench"></i></a></li>';                      
                      ?>
                    </ul>         
                </nav>
              </div>
                  ...
                  <div class="col-md-12">
                    <div class="card">
                      <div class="card-header col-md-9">
                        <h3 class="card-title text-center">User Areas</h3>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                        <table id="incidents" class="table table-bordered table-striped">
                          ...
                          <tbody>
                          <?php
                            $user_areas = explode(',', $row_user["user_areas"]);
                            foreach ($user_areas as $value) {
                              $sql = "select * from areas where id =$value";
