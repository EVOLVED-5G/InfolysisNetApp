...
<div class="wrapper">
  ...
  <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="col-md-10">
          <?php 
            $sql_user_name = "SELECT * FROM users WHERE id = ".htmlspecialchars($_GET["user_id"]);
            $result_user_name = m_execute_query($con, $sql_user_name);
            $row_user_name = mysqli_fetch_array($result_user_name);
            echo "<h1>
              User : ".$row_user_name['name']." ".$row_user_name['surname']."
            </h1>"; 
          ?>
        </div>                
      </section>
            ...
            <div class="box">
              <div id="incident_selection">
                <nav class="navbar navbar-default">
                    <ul class="nav navbar-nav">
                      <?php
                      echo '<li id="incident_info_selection"><a href="user_info.php?user_id='.htmlspecialchars($_GET["user_id"]).'">Info<i class="fa fa-fw fa-info-circle"></i><span class="sr-only">(current)</span></a></li>';
                      echo '<li id="incident_questions_selection"><a href="user_areas.php?user_id='.htmlspecialchars($_GET["user_id"]).'">Areas<i class="fa fa-fw fa-map"></i></a></li>';
                      echo '<li class="active" id="incident_answers_selection"><a href="user_incidents.php?user_id='.htmlspecialchars($_GET["user_id"]).'">Incidents<i class="fa fa-fw fa-wrench"></i></a></li>';                      
                      ?>
                    </ul>         
                </nav>
              </div>
                  ...
                  <div class="col-md-12">
                    <div class="card">
                      <div class="card-header col-md-9">
                        <h3 class="card-title text-center">User Incidents</h3>
                      </div>
                      ...
                      <div class="card-body">
                        <table id="incidents" class="table table-bordered table-striped">
                          ...
                          <?php
                            ...
                            $sql = "select * from incidents where user_id =".htmlspecialchars($_GET["user_id"]);
